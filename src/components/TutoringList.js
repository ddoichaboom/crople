...
const TutoringList = ({ onSubmit }) => {
  ...
  const fetchBoardData = async () => {
    const category = Categories.TUTORING;
      ...
      >
        <View style={styles.ContainerStyle}>
          <View style={styles.infoContainer}>
            <Text style={styles.textStyle}>과목: {item.subject}</Text>
            <Text style={styles.textStyle}>위치: {item.location}</Text>
            <Text style={styles.textStyle}>시간 당 가격: {displayPrice}</Text>
