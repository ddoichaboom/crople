...
const TutoringDetailScreen = ({ route }) => {
      ...
      <View style={[styles.container, { paddingBottom: height / 10 }]}>
        ...
        <View style={styles.rowContainer}>
          ...
          <View style={styles.titleContainer}>
            <Text style={styles.defaultTextStyle}>주제 :</Text>
            <Text style={styles.defaultTextStyle}>위치 :</Text>
            <Text style={styles.defaultTextStyle}>시간 당 가격 :</Text>
            <Text style={styles.defaultTextStyle}>상태 :</Text>
          </View>

          <View style={styles.infoContainer}>
            <Text style={styles.infoStyle}>{boardData.subject}</Text>
            <Text style={styles.infoStyle}>{boardData.location}</Text>
            <Text style={styles.infoStyle}>{TutoringPrice}</Text>
...
TutoringDetailScreen.propTypes = {
